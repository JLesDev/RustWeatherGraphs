...
impl SinglePointDataset {
    ...
    pub fn border_width(mut self, value: impl Into<NumberStringOrT<Border>>) -> SinglePointDataset {
    ...
    pub fn hover_border_width(
        mut self,
        value: impl Into<NumberStringOrT<Border>>,
    ) -> SinglePointDataset {
        self.hoverBorderWidth = Some(value.into());
        self
    }
    ...
    pub fn point_border_width(
        mut self,
        value: impl Into<NumberStringOrT<Border>>,
    ) -> SinglePointDataset {
        self.pointBorderWidth = Some(value.into());
        self
    }
    ...
    pub fn point_hover_border_width(
        ...
        self.pointHoverBorderWidth = Some(value.into());
        self
    }
...
impl crate::ChartJsRsObject for SinglePointDataset {}
...
impl XYDataset {
    ...
    pub fn hover_border_width(mut self, value: impl Into<NumberStringOrT<Border>>) -> XYDataset {
        self.hoverBorderWidth = Some(value.into());
        self
    }
    ...
    pub fn point_border_width(mut self, value: impl Into<NumberStringOrT<Border>>) -> XYDataset {
        self.pointBorderWidth = Some(value.into());
        self
    }
...
impl crate::ChartJsRsObject for XYDataset {}
...
impl crate::ChartJsRsObject for XYPoint {}
...
impl<A: Annotation> crate::ChartJsRsObject for ChartOptions<A> {}
...
impl crate::ChartJsRsObject for Animation {}
...
impl<A: Annotation> crate::ChartJsRsObject for ChartPlugins<A> {}
...
impl crate::ChartJsRsObject for PluginLegend {}
...
impl<A: Annotation> crate::ChartJsRsObject for Annotations<A> {}
...
impl crate::ChartJsRsObject for AutoColors {}
...
impl TooltipPlugin {
    ...
    pub fn filter(mut self, value: FnWithArgs<1>) -> TooltipPlugin {
        self.filter = value;
        self
    }
...
impl crate::ChartJsRsObject for TooltipPlugin {}
...
impl crate::ChartJsRsObject for ChartLayout {}
...
impl TooltipCallbacks {
    ...
    pub fn label(mut self, value: FnWithArgs<1>) -> TooltipCallbacks {
        self.label = value;
        self
    }
    ...
    pub fn title(mut self, value: FnWithArgs<1>) -> TooltipCallbacks {
        self.title = value;
        self
    }
}

impl crate::ChartJsRsObject for TooltipCallbacks {}
...
impl ChartScale {
    ...
    pub fn after_build_ticks(mut self, value: FnWithArgs<1>) -> ChartScale {
        self.afterBuildTicks = value;
        self
    }
    ...
    pub fn before_fit(mut self, value: FnWithArgs<1>) -> ChartScale {
        self.beforeFit = value;
        self
    }
    ...
    pub fn labels<T: Into<NumberOrDateString>, U: IntoIterator<Item = T>>(
        mut self,
        value: U,
    ) -> ChartScale {
...
impl crate::ChartJsRsObject for ChartScale {}
...
impl crate::ChartJsRsObject for ScaleBorder {}
...
impl crate::ChartJsRsObject for Grid {}
...
impl LineAnnotation {
    ...
    pub fn border_width(mut self, value: impl Into<NumberStringOrT<Border>>) -> LineAnnotation {
        self.borderWidth = Some(value.into());
        self
    }
...
impl crate::ChartJsRsObject for LineAnnotation {}
...
impl crate::ChartJsRsObject for LineAnnotationType {}
...
impl BoxAnnotation {
    ...
    pub fn border_width(mut self, value: impl Into<NumberStringOrT<Border>>) -> BoxAnnotation {
        self.borderWidth = Some(value.into());
        self
    }
...
impl crate::ChartJsRsObject for BoxAnnotation {}
...
impl crate::ChartJsRsObject for BoxAnnotationType {}
...
impl crate::ChartJsRsObject for ScaleTime {}
...
impl crate::ChartJsRsObject for DisplayFormats {}
...
impl ScaleTicks {
    ...
    pub fn callback(mut self, value: FnWithArgs<3>) -> ScaleTicks {
        self.callback = value;
        self
    }
    ...
    pub fn color(mut self, value: impl Into<String>) -> ScaleTicks {
        self.color = value.into();
        self
    }
...
impl crate::ChartJsRsObject for ScaleTicks {}
...
impl Title {
    ...
    pub fn color(mut self, value: impl Into<String>) -> Title {
        self.color = value.into();
        self
    }
...
impl crate::ChartJsRsObject for Title {}
...
impl crate::ChartJsRsObject for ChartInteraction {}
...
impl crate::ChartJsRsObject for ChartLegend {}
...
impl LegendLabel {
    ...
    pub fn color(mut self, value: impl Into<String>) -> LegendLabel {
        self.color = value.into();
        self
    }
    ...
    pub fn filter(mut self, value: FnWithArgs<2>) -> LegendLabel {
        self.filter = value;
        self
    }
...
impl crate::ChartJsRsObject for LegendLabel {}
...
impl crate::ChartJsRsObject for ChartElements {}
...
impl crate::ChartJsRsObject for BarElementConfiguration {}
...
impl crate::ChartJsRsObject for LineElementConfiguration {}
...
impl crate::ChartJsRsObject for PointElementConfiguration {}
...
impl DataLabels {
    ...
    pub fn formatter(mut self, value: FnWithArgs<2>) -> DataLabels {
...
impl crate::ChartJsRsObject for DataLabels {}
...
impl crate::ChartJsRsObject for Border {}
...
impl crate::ChartJsRsObject for Padding {}
...
impl crate::ChartJsRsObject for Font {}
...
impl Segment {
    ...
    pub fn border_color(mut self, value: FnWithArgs<1>) -> Segment {
    ...
    pub fn border_dash(mut self, value: FnWithArgs<1>) -> Segment {
        self.borderDash = value;
        self
    }
}

impl crate::ChartJsRsObject for Segment {}
