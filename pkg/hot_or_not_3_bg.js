 ...
 */
export function get_url(locan, API) {
    const ptr0 = passStringToWasm0(locan, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(API, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.get_url(ptr0, len0, ptr1, len1);
    return ret;
}
...
export function __wbindgen_closure_wrapper708(arg0, arg1, arg2) {
